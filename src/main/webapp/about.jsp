					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								...
								<p><a href="${path}/front?key=furniture&methodName=selectFurnitureList" class="btn btn-secondary me-2">상품 보러 가기</a></p>
							</div>
						</div>
						<div class="col-lg-7">
		...
		<div class="untree_co-section">
			<div class="container">
				...
				<div class="row">
					...
					<img src="${path}/assets/images/images/nuso1.jpg" class="img-fluid mb-5">
						<h3>신창훈</h3>
